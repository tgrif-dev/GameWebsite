        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} w="100%" gap={{ base: 10, md: 16 }}>
          <VStack align="start" gap={5}>
            <Text fontSize={{ base: 'md', md: 'lg' }} color="textMuted" lineHeight="1.9">
              Lost Society is built by nine students at Aston University as an eighteen
            ...
            <Text fontSize={{ base: 'md', md: 'lg' }} color="textMuted" lineHeight="1.9">
              ...
              everything, this has allowed us to deliver the highest quality game possible!
            </Text>
            <Text fontSize={{ base: 'md', md: 'lg' }} color="textMuted" lineHeight="1.9">
              The devlog is where we write up what we are working on. The newsletter
              sends the same posts to your inbox, so you never miss an update!
            </Text>
          </VStack>
